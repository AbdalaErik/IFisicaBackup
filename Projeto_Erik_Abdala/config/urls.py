...
urlpatterns = [
    ...
    path("teste1/", TopicoListView.as_view(), name = 'topicoList'),
    path("teste1/<int:pk>/", TopicoDetailView.as_view(), name = 'topicoDetail'),

    path("teste3/", QuestionarioListView.as_view(), name = 'questionarioList'),
    path("teste3/<int:pk>/", QuestionarioDetailView.as_view(), name = 'questionarioDetail'),
